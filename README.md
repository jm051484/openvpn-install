...
```apt update && apt -y upgrade && apt-get -y install curl && curl -O https://raw.githubusercontent.com/jm051484/openvpn-install/master/openvpn-install.sh && chmod +x openvpn-install.sh && ./openvpn-install.sh```
